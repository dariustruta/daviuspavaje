...
document.querySelectorAll('[data-gallery]').forEach(b=>b.addEventListener('click',()=>{const g=galleryData[b.dataset.gallery];openGallery(g.imgs,g.title)}));document.querySelectorAll('[data-full]').forEach(b=>b.addEventListener('click',()=>openGallery([b.dataset.full],b.querySelector('em')?.textContent||'')));
